...
flags.DEFINE_integer("position_dim", 25, "position_dim")
...
flags.DEFINE_integer("label_dim", 500, "label_dim")
flags.DEFINE_integer("num_filter", 500, "num_filter")
flags.DEFINE_float("l2_learning", 0.0001, "l2_learning")
flags.DEFINE_float("learningrate", 0.03, "learningrate")
...
def main(_):
    with tf.Graph().as_default():
        train_data, test_data, word_embed= loaddata.inputs()
        mtrain, mtest = model.train_or_valid(train_data, test_data, word_embed)
